...
export const updateEnderecoEntregaValidator = vine.compile(
    vine.object({
        ...
        endereco: vine.string().trim().maxLength(255).optional(),
        cidade: vine.string().trim().maxLength(100).optional(),
        estado: vine.string().trim().maxLength(100).optional(),
        caixaPostal: vine.string().trim().maxLength(20).optional(),
        pais: vine.string().trim().maxLength(100).optional()
    })
)
